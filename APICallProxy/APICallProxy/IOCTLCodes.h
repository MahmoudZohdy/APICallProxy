...
#define API_PROXY_CREATEREGISTRY 0x8009
#define IOCTL_API_PROXY_CREATEREGISTRY CTL_CODE(API_PROXY_CREATEREGISTRY, 0x800, DATA_TRANSFIRE_MODE, FILE_ANY_ACCESS)

#define API_PROXY_DELETEREGISTRY 0x8010
#define IOCTL_API_PROXY_DELETEREGISTRY CTL_CODE(API_PROXY_DELETEREGISTRY, 0x800, DATA_TRANSFIRE_MODE, FILE_ANY_ACCESS)

#define API_PROXY_WRITEREGISTRY 0x8011
#define IOCTL_API_PROXY_WRITEREGISTRY CTL_CODE(API_PROXY_WRITEREGISTRY, 0x800, DATA_TRANSFIRE_MODE, FILE_ANY_ACCESS)

#define API_PROXY_READREGISTRY 0x8012
#define IOCTL_API_PROXY_READREGISTRY CTL_CODE(API_PROXY_READREGISTRY, 0x800, DATA_TRANSFIRE_MODE, FILE_ANY_ACCESS)
